<div class="container-fluid feature pb-5">
    <div class="container pb-5">
        <div class="text-center mx-auto pb-5 wow fadeInUp" data-wow-delay="0.2s" style="max-width: 800px;">
            ...
            <h1 class="display-5 mb-4">Enhancing Your Sports Experience at PlayZone</h1>
            <p class="mb-0">At PlayZone, we provide a range of features designed to make your sporting experience seamless and enjoyable. From booking your favorite courts to accessing top-notch facilities, discover how we cater to all your athletic needs.</p>
        </div>
        <div class="row g-4">
            <div class="col-md-6 col-lg-3 wow fadeInUp" data-wow-delay="0.2s">
                <div class="feature-item d-flex flex-column align-items-center p-4">
            ...
            <div class="col-md-6 col-lg-3 wow fadeInUp" data-wow-delay="0.6s">
                <div class="feature-item d-flex flex-column align-items-center p-4">
                    ...
                    <h4 class="text-center mb-3">Group Bookings</h4>
                    <p class="text-center mb-4">Manage group bookings effortlessly for team sports or events, ensuring everyone has a great time.</p>
                </div>
            </div>
